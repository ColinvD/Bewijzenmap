...
function dobbelsteen($worp){
    ...
    $color5 = imagecolorallocate($im, rand(0, 255),rand(0, 255),rand(0, 255));
    $color6 = imagecolorallocate($im, rand(0, 255),rand(0, 255),rand(0, 255));
    $color7 = imagecolorallocate($im, rand(0, 255),rand(0, 255),rand(0, 255));
    /*
